...
pacman::p_load(gamm4, dplyr, lme4, MASS, lmerTest, here, DHARMa, MuMIn, mgcv, ggplot2, gratia, patchwork, ggeffects, extrafont) # load packages 
...
loadfonts(device = "pdf")   # add font for figures
